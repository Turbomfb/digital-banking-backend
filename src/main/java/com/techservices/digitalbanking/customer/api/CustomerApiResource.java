...
public class CustomerApiResource {
	...
	@Operation(
			...
			description = "Creates a new customer account in the digital banking system. Supports both retail and corporate customer types with optional OTP generation.",
	...
	@Operation(
			...
			description = "Fetches identity verification data using NIN (National Identification Number) or BVN (Bank Verification Number). Returns personal information for verification purposes."
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
					...
					content = @Content(
							mediaType = "application/json",
							schema = @Schema(implementation = IdentityVerificationResponse.IdentityVerificationResponseData.class)
					)
			),
			@ApiResponse(
					responseCode = "400",
	...
	public ResponseEntity<IdentityVerificationResponse.IdentityVerificationResponseData> retrieveIdentityData(
		...
		try {
			...
			throw new ValidationException("validation.error.exists", "We’re unable to retrieve your identity details at the moment. Please check your BVN/NIN and try again, or try later.", e.getMessage());
		}
	}

	@Operation(
			summary = "Retrieve Business Identity Verification Data",
			description = "Fetches business identity verification data using RC Number (Registration Certificate) or TIN (Tax Identification Number). Used for corporate customer verification."
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Updates an existing customer's profile information. Requires authentication and appropriate permissions.",
			requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
	...
	@Operation(
			...
			description = "Retrieves the profile information of the currently authenticated customer, including loan pre-qualification status."
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Retrieves a paginated list of all customers in the system. This endpoint is typically used by administrators or staff members."
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Retrieves comprehensive dashboard information for the authenticated customer, including account balances, recent transactions, and financial summary."
	)
	@ApiResponses(value = {
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Creates or updates a transaction PIN for the specified customer. This PIN is used for authorizing financial transactions.",
			requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
	...
	@Operation(
			...
			description = "Initiates the account closure process for the authenticated customer. This action may require additional verification steps and cannot be undone.",
			requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
	...
	public ResponseEntity<GenericApiResponse> closeAccount(
			@Parameter(description = "Account closure request details", required = true)

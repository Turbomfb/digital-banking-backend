...
@Tag(
    ...
    description = "APIs for managing customer accounts, profiles, and related operations")
...
public class CustomerApiResource {
  ...
  @Operation(
      ...
      description =
          "Creates a new customer account in the digital banking system. Supports both retail and corporate customer types with optional OTP generation.",
      requestBody =
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "409",
            description = "Customer already exists with provided email or phone number",
            content = @Content(mediaType = "application/json"))
      })
  @PostMapping
  public ResponseEntity<BaseAppResponse> createMerchantAccount(
      @Parameter(description = "Customer creation request details", required = true)
          @Validated
          @RequestBody
          CreateCustomerRequest createCustomerRequest,
      @Parameter(
              description = "Command to execute during customer creation",
              example = "generate-otp",
              schema = @Schema(allowableValues = {"generate-otp", "skip-otp"}))
          @RequestParam(name = "command", required = false, defaultValue = "generate-otp")
          String command,
      @Parameter(
              description = "Type of customer account to create",
              example = "RETAIL",
              schema = @Schema(implementation = UserType.class))
          @RequestParam(name = "customerType", required = false, defaultValue = "RETAIL")
          UserType customerType) {

    BaseAppResponse postClientsResponse =
        customerService.createCustomer(createCustomerRequest, command, customerType);
    return new ResponseEntity<>(postClientsResponse, HttpStatusCode.valueOf(201));
  }

  @Operation(
      summary = "Retrieve Identity Verification Data",
      description =
          "Fetches identity verification data using NIN (National Identification Number) or BVN (Bank Verification Number). Returns personal information for verification purposes.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    ...
                    schema =
                        @Schema(
                            implementation =
                                IdentityVerificationResponse.IdentityVerificationResponseData
                                    .class))),
        @ApiResponse(
            responseCode = "400",
            description = "Invalid identity type or identity value format",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
            description = "Identity data not found for the provided value",
            content = @Content(mediaType = "application/json"))
      })
  @GetMapping("identity-verification")
  public ResponseEntity<IdentityVerificationResponse.IdentityVerificationResponseData>
      retrieveIdentityData(
          @Parameter(
                  description = "Type of identity verification to perform",
                  required = true,
                  example = "NIN",
                  schema = @Schema(implementation = IdentityVerificationDataType.class))
              @RequestParam(name = "identityType")
              IdentityVerificationDataType identityType,
          @Parameter(
                  description = "Identity verification value (NIN or BVN number)",
                  required = true,
                  example = "12345678901")
              @RequestParam(name = "identityValue")
    ...
    try {
      ...
      if (identityType == IdentityVerificationDataType.NIN) {
        ...
        throw new ValidationException(
            "validation.error.exists", "Unsupported identity type: " + identityType);
      }
  ...
  @Operation(
      summary = "Retrieve Business Identity Verification Data",
      description =
          "Fetches business identity verification data using RC Number (Registration Certificate) or TIN (Tax Identification Number). Used for corporate customer verification.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Business identity data retrieved successfully",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = BusinessDataResponse.BusinessData.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Either RC Number or TIN must be provided",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
            description = "Business data not found for the provided identifier",
            content = @Content(mediaType = "application/json"))
      })
  @GetMapping("business-identity-verification")
  public ResponseEntity<BusinessDataResponse.BusinessData> retrieveIdentityData(
      @Parameter(description = "Business Registration Certificate Number", example = "RC123456")
          @RequestParam(name = "rcNumber", required = false)
          String rcNumber,
      @Parameter(description = "Tax Identification Number", example = "12345678-0001")
          @RequestParam(name = "tin", required = false)
          String tin) {
  ...
  @Operation(
      ...
      description =
          "Updates an existing customer's profile information. Requires authentication and appropriate permissions.",
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Insufficient permissions to update this customer",
            content = @Content(mediaType = "application/json"))
      })
  @SecurityRequirement(name = "bearerAuth")
  @PutMapping("{customerId}")
  public ResponseEntity<CustomerDtoResponse> updateCustomer(
      @Parameter(description = "Customer update request details", required = true)
          @Validated
          @RequestBody
    ...
    CustomerDtoResponse customerDtoResponse =
        CustomerDtoResponse.parse(
            customerService.updateCustomer(customerUpdateRequest, customerId, null, true));
  ...
  @Operation(
      ...
      description =
          "Retrieves the profile information of the currently authenticated customer, including loan pre-qualification status.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<CustomerDtoResponse> getCustomerById() {
    ...
    CustomerDtoResponse response =
        CustomerDtoResponse.parse(customerService.getCustomerById(customerId));
  ...
  @Operation(
      ...
      description =
          "Retrieves a paginated list of all customers in the system. This endpoint is typically used by administrators or staff members.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Insufficient permissions to access customer list",
            content = @Content(mediaType = "application/json"))
      })
  @SecurityRequirement(name = "bearerAuth")
  @GetMapping
  ...
  @Operation(
      ...
      description =
          "Retrieves comprehensive dashboard information for the authenticated customer, including account balances, recent transactions, and financial summary.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "404",
            description = "Customer dashboard data not found",
            content = @Content(mediaType = "application/json"))
      })
  @SecurityRequirement(name = "bearerAuth")
  ...
  @Operation(
      ...
      description =
          "Creates or updates a transaction PIN for the specified customer. This PIN is used for authorizing financial transactions.",
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
              description = "Transaction PIN creation request",
              required = true,
              content =
                  @Content(
                      mediaType = "application/json",
                      schema = @Schema(implementation = CustomerTransactionPinRequest.class))))
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid PIN format or PIN confirmation mismatch",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Insufficient permissions to create PIN for this customer",
            content = @Content(mediaType = "application/json"))
      })
  @SecurityRequirement(name = "bearerAuth")
  @PostMapping("{customerId}/transaction-pin")
  public ResponseEntity<GenericApiResponse> createTransactionPin(
      @Parameter(description = "Transaction PIN creation request details", required = true)
          @RequestBody
    ...
    GenericApiResponse genericApiResponse =
        customerService.createTransactionPin(customerId, customerTransactionPinRequest);
  ...
  @Operation(
      ...
      description =
          "Initiates the account closure process for the authenticated customer. This action may require additional verification steps and cannot be undone.",
      requestBody =
          @io.swagger.v3.oas.annotations.parameters.RequestBody(
              description = "Account closure request details",
              required = true,
              content =
                  @Content(
                      mediaType = "application/json",
                      schema = @Schema(implementation = CustomerAccountClosureRequest.class))))
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Account closure request processed successfully",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = GenericApiResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description = "Invalid closure request or outstanding obligations",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "401",
            description = "Authentication required",
        ...
        @ApiResponse(
            responseCode = "409",
            description = "Account cannot be closed due to pending transactions or active services",
            content = @Content(mediaType = "application/json"))
      })
  @SecurityRequirement(name = "bearerAuth")
  @PostMapping("me/close-account")
  public ResponseEntity<GenericApiResponse> closeAccount(
      @Parameter(description = "Account closure request details", required = true) @RequestBody
          CustomerAccountClosureRequest request) {
  ...
  public ResponseEntity<GenericApiResponse> activateAccount(
      @RequestBody CustomerAccountActivationRequest request, @RequestParam UserType userType) {

...
public class LoanScheduleCalculationResponse {
  ...
  public static LoanScheduleCalculationResponse parse(
      PostLoansResponse loanSchedule,
    ...
    LoanScheduleCalculationResponse loanScheduleCalculationResponse =
        new LoanScheduleCalculationResponse();
    ...
    if (totalRepayable.compareTo(BigDecimal.ZERO) > 0 && loanTermFrequency > 0) {
      monthlyRepayment =
          totalRepayable
              .divide(BigDecimal.valueOf(loanTermFrequency), RoundingMode.HALF_UP)

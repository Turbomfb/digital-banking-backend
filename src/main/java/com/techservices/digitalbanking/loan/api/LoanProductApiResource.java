...
@Tag(
    name = "Loan Products",
    description =
        "API for managing loan product configurations, templates, and loan schedule calculations")
...
public class LoanProductApiResource {
  ...
  public ResponseEntity<BasePageResponse<LoanProductListResponse>> getLoanProducts(
    ...
    BasePageResponse<LoanProductListResponse> getLoanProductsProductIdResponses =
        loanProductService.getLoanProducts(fields);
  ...
  @Operation(
      ...
      description =
          "Fetches detailed configuration information for a specific loan product including "
  ...
  public ResponseEntity<GetLoanProductsProductIdResponse> getLoanProductById(
      ...
      @Parameter(
              name = "fields",
              description =
                  "Comma-separated list of specific fields to include in the response for bandwidth optimization. "
      ...
      @Parameter(
              name = "template",
              description =
                  "Flag to include template data with dropdown options, reference data, and default values "
    ...
    GetLoanProductsProductIdResponse getLoanProductsProductIdResponse =
        loanProductService.getLoanProductById(productId, fields, template);
  ...
  @Operation(
      ...
      description =
          "Fetches the comprehensive loan product template containing all available configuration options, "
  ...
  public ResponseEntity<GetLoanProductsTemplateResponse> retrieveLoanProductTemplate() {
    ...
    GetLoanProductsTemplateResponse getLoanProductsTemplateResponse =
        loanProductService.retrieveLoanProductTemplate();

...
public class InvestmentApiResource {
	...
	@PostMapping
	public ResponseEntity<PostRecurringDepositAccountsResponse> submitApplication(
			@RequestBody PostRecurringDepositAccountsRequest postRecurringDepositAccountsRequest,
			@Valid @RequestParam(value = "activate", defaultValue = "false", required = false) boolean activate) {
		PostRecurringDepositAccountsResponse postSavingsAccountsResponse = investmentService
				.submitApplication(postRecurringDepositAccountsRequest, activate);
	...
	public ResponseEntity<PostRecurringDepositAccountsResponse> processInvestmentCommand(
			@PathVariable("investmentId") Long investmentId,
			@Valid @RequestBody(required = false) RecurringDepositCommandRequest recurringDepositCommandRequest,
			@Valid @RequestParam(value = "command") String command) {
		PostRecurringDepositAccountsResponse postFixedDepositAccountsAccountIdResponse = investmentService
				.processInvestmentCommand(investmentId, recurringDepositCommandRequest, command);
	...
	@GetMapping
	public ResponseEntity<List<GetRecurringDepositAccountsResponse>> retrieveAllInvestments(
		...
		List<GetRecurringDepositAccountsResponse> investments = investmentService.retrieveAllInvestments(paged, offset,
	...
	@GetMapping("{id}")
	public ResponseEntity<GetRecurringDepositAccountsResponse> retrieveInvestmentById(@PathVariable Long id,
		...
		GetRecurringDepositAccountsResponse investment = investmentService.retrieveInvestmentById(id,

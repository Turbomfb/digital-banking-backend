...
public class GetLoanProductsTransactionProcessingStrategyOptions {
	 ...
	 * @return code
	 */
	@Schema(name = "code", example = "mifos-standard-strategy", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@JsonProperty("code")
	 ...
	 * @return name
	 */
	@Schema(name = "name", example = "Penalties, Fees, Interest, Principal order", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@JsonProperty("name")

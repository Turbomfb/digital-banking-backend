...
@Schema(name = "GetLoansLoanIdCollateralsResponse", description = "GetLoansLoanIdCollateralsResponse")
...
public class GetLoansLoanIdCollateralsResponse {
	 ...
	 * @return description
	 */
	@Schema(name = "description", example = "24 Carat Gold chain weighing 12 grams", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

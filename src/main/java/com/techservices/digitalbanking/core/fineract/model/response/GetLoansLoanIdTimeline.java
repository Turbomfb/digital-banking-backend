...
public class GetLoansLoanIdTimeline {
	 ...
	 */
	@Schema(name = "approvedByFirstname", example = "App", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "approvedByLastname", example = "Administrator", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "approvedByUsername", example = "admin", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "disbursedByFirstname", example = "App", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "disbursedByLastname", example = "Administrator", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "disbursedByUsername", example = "admin", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "submittedByFirstname", example = "App", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "submittedByLastname", example = "Administrator", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "submittedByUsername", example = "admin", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	...
	@Override
	public int hashCode() {
		return Objects.hash(actualDisbursementDate, approvedByFirstname, approvedByLastname, approvedByUsername,
				approvedOnDate, closedOnDate, disbursedByFirstname, disbursedByLastname, disbursedByUsername,
				expectedDisbursementDate, expectedMaturityDate, submittedByFirstname, submittedByLastname,
				submittedByUsername, submittedOnDate);
	}

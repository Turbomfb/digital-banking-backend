...
@Schema(name = "PutLoansLoanIdChargesChargeIdRequest", description = " PutLoansLoanIdChargesChargeIdRequest")
...
public class PutLoansLoanIdChargesChargeIdRequest {
	 ...
	 * @return dueDate
	 */
	@Schema(name = "dueDate", example = "27 March 2013", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

...
public class GetLoanProductsInterestRecalculationCompoundingFrequencyType {
	 ...
	 * @return code
	 */
	@Schema(name = "code", example = "interestRecalculationFrequencyType.same.as.repayment.period", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@JsonProperty("code")
	...
	public GetLoanProductsInterestRecalculationCompoundingFrequencyType description(String description) {
	...
	public boolean equals(Object o) {
		...
		GetLoanProductsInterestRecalculationCompoundingFrequencyType getLoanProductsInterestRecalculationCompoundingFrequencyType = (GetLoanProductsInterestRecalculationCompoundingFrequencyType) o;
		return Objects.equals(this.code, getLoanProductsInterestRecalculationCompoundingFrequencyType.code)

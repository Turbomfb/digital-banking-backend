...
public class AddressApiResource {
    ...
    @Operation(
            ...
            description = "Fetches a paginated list of all addresses associated with the currently authenticated customer"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Fetches a specific address for the authenticated customer based on the address type (e.g., HOME, WORK, BILLING)"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Updates an existing address for the authenticated customer. Creates a new address if one doesn't exist for the specified type"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Permanently removes an address of the specified type for the authenticated customer"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    @Operation(
            ...
            description = "Fetches a paginated list of all states/provinces available in the system for address selection"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Fetches a paginated list of all Local Government Areas (LGAs) within the specified state"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<BasePageResponse<String>> getLgasForState(
            @Parameter(
                    description = "Name of the state to retrieve LGAs for",
                    required = true
            )

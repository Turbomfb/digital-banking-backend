...
public class FileDownloadController {
	...
	public ResponseEntity<Resource> downloadGuarantorForm(@RequestParam(defaultValue = "false") boolean inline) {
		...
		return ResponseEntity.ok().contentType(MediaType.APPLICATION_PDF).header(HttpHeaders.CONTENT_DISPOSITION,
				(inline ? "inline" : "attachment") + "; filename=\"" + filename + "\"").body(resource);
	}

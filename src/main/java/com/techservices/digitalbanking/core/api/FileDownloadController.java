...
public class FileDownloadController {
  ...
  @Operation(
      summary = "Download guarantor form",
      description = "Download the KKU guarantor form PDF")
  ...
  @Operation(
      ...
      description = "Download any file from the files directory")
  public ResponseEntity<Resource> downloadFile(
      @RequestParam String fileName, @RequestParam(defaultValue = "false") boolean inline) {

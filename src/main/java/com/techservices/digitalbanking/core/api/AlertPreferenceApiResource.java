...
public class AlertPreferenceApiResource {
	...
	public ResponseEntity<AlertPreference> updatePreference(@PathVariable AlertType alertType,
			@RequestParam boolean viaSms, @RequestParam boolean viaEmail, @RequestParam boolean viaPush) {

		Long customerId = springSecurityAuditorAware.getAuthenticatedUser().getUserId();
		AlertPreference updated = alertPreferenceService.updatePreference(customerId, alertType, viaSms, viaEmail,
				viaPush);
	...
	public ResponseEntity<AlertPreference> enableChannel(@PathVariable AlertType alertType,
	...
	public ResponseEntity<AlertPreference> disableChannel(@PathVariable AlertType alertType,
			@PathVariable String channel) {

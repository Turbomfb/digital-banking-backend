...
@Tag(
    name = "Beneficiaries",
    description =
        "APIs for managing customer beneficiaries including CRUD operations, OTP verification, and search functionality")
...
public class BeneficiaryApiResource {
  ...
  @Operation(
      ...
      description =
          "Fetches a list of all active beneficiaries associated with the currently authenticated customer")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Fetches a list of beneficiaries that the customer transacts with most frequently, ordered by transaction frequency")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Fetches detailed information for a specific beneficiary belonging to the authenticated customer")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Initiates the process to add a new beneficiary to the customer's list. This is a two-step process: "
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description =
                "OTP generated successfully or beneficiary added successfully after verification",
            content =
                @Content(
                    mediaType = "application/json",
  ...
  public ResponseEntity<GenericApiResponse> addBeneficiary(
      @Parameter(
              description =
                  "Beneficiary details including account information and optional nickname. "
      ...
      @Parameter(
              description =
                  "Command to execute: 'generate' to initiate OTP generation, 'verify' to complete beneficiary addition with OTP",
              example = "generate")
  ...
  @Operation(
      ...
      description =
          "Updates beneficiary details such as nickname. This is a two-step process: "
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description =
                "OTP generated successfully or beneficiary updated successfully after verification",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = GenericApiResponse.class))),
  ...
  public ResponseEntity<GenericApiResponse> updateBeneficiary(
      @Parameter(
              description =
                  "Command to execute: 'generate' to initiate OTP generation, 'verify' to complete beneficiary update with OTP",
              example = "generate")
          @RequestParam(value = "command", required = false, defaultValue = GENERATE_OTP_COMMAND)
          @Valid
          String command,
  ...
  @Operation(
      ...
      description =
          "Removes a beneficiary from the customer's list. This is a two-step process: "
  ...
  public ResponseEntity<Void> deleteBeneficiary(
      ...
      @Parameter(
              description =
                  "Command to execute: 'generate' to initiate OTP generation, 'verify' to complete beneficiary deletion with OTP",
              example = "generate")
          @RequestParam(value = "command", required = false, defaultValue = GENERATE_OTP_COMMAND)
          @Valid
          String command) {
  ...
  @Operation(
      ...
      description =
          "Searches through the customer's beneficiaries using a search term that matches against account number, nickname, or account name. Returns all matching beneficiaries")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description =
                "Successfully retrieved matching beneficiaries (may be empty if no matches found)",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = BeneficiaryListResponse.class))),
  ...
  public ResponseEntity<BeneficiaryListResponse> searchBeneficiaries(
      @Parameter(
              description =
                  "Search term to match against account number, nickname, or account name (case-insensitive, partial matches supported)",
              required = true,
              example = "John")
          @RequestParam
          String searchTerm) {
    ...
    Long customerId = springSecurityAuditorAware.getAuthenticatedUser().getUserId();
    log.info(
        "GET /api/v1/customers/me/beneficiaries/search?searchTerm={} - customerId: {}",
        searchTerm,
        customerId);

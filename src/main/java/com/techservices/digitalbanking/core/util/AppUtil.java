...
public class AppUtil {
	...
	public static final String[] PUBLIC_ENDPOINTS = {"/api-docs/**", "/swagger-ui/**", "/swagger-ui.html",
			"/actuator/health", "/actuator/info", "/api/v1/cba/health"};

	public static final String[] PUBLIC_POST_ENDPOINTS = {"/api/v1/customers",
			"/api/v1/loan-products/loan-schedule-calculation", "/api/v1/customers/{customerId}/transaction-pin",
			"/api/v1/customers/me/activate-account", "/api/v1/auth", "/api/v1/wallet-accounts/me/transactions/webhooks",
			"/api/v1/auth/create-password", "/api/v1/auth/forgot-password"};

	public static final String DIRECTORS_DATATABLE_NAME = "Directors";

	public static final String[] PUBLIC_GET_ENDPOINTS = {"/api/v1/customers/identity-verification",
			"/api/v1/customers/business-identity-verification", "api/v1/loan-products", "api/v1/system/codes/**",
			"api/v1/privacy-policy", "api/v1/docs", "api/v3/api-docs/customers", "api/v3/api-docs",
			"api/v3/api-docs/swagger-config", "api/v1/swagger-ui/favicon-16x16.png",
			"api/v1/swagger-ui/favicon-32x32.png", "api/v1/swagger-ui/swagger-initializer.js",
			"api/v1/swagger-ui/index.css", "api/v1/swagger-ui/swagger-ui-bundle.js",
			"api/v1/swagger-ui/swagger-ui-standalone-preset.js", "api/v1/swagger-ui/swagger-ui.css",
			"api/v1/swagger-ui/index.html", "api/v1/customers/me/addresses/states",

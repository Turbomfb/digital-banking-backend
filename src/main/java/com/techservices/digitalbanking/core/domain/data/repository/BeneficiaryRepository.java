...
public interface BeneficiaryRepository extends JpaRepository<Beneficiary, Long> {
	...
	Optional<Beneficiary> findByCustomerIdAndAccountNumberAndBankCode(Long customerId, String accountNumber,
			String bankCode);
	...
	@Query("SELECT b FROM Beneficiary b WHERE b.customerId = :customerId AND b.isActive = true "
			...
			+ "OR b.accountNumber LIKE CONCAT('%', :searchTerm, '%')) " + "ORDER BY b.lastUsedAt DESC")

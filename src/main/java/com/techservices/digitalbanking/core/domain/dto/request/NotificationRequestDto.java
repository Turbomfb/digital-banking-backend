...
public class NotificationRequestDto {
    ...
    public String getOtpResponseMessage() {
        ...
        if (StringUtils.isNotBlank(phoneNumber) && StringUtils.isBlank(emailAddress)) message += AppUtil.maskPhoneNumber(phoneNumber);
        else if (StringUtils.isNotBlank(emailAddress) && StringUtils.isBlank(phoneNumber)) message += AppUtil.maskEmailAddress(emailAddress);
        else if (StringUtils.isNotBlank(emailAddress) && StringUtils.isNotBlank(phoneNumber)) message += AppUtil.maskPhoneNumber(phoneNumber)+" and "+AppUtil.maskEmailAddress(emailAddress);

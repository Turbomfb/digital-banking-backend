...
public class OpenApiConfig {
	...
	public OpenAPI customOpenAPI() {
		...
		return new OpenAPI().info(new Info().title("Digital Banking Core API").version("v1.0.0").description(
				...
				.contact(new Contact().name("Techservice Engineering Team").email("engineering@techservice.com")

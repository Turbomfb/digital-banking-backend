...
public class ApiService {
	...
	public <T> T callExternalApi(String url, Class<T> responseType, HttpMethod method, Object requestPayload,
			HttpHeaders headers) throws JsonProcessingException {

		log.info("Calling external API with details: URL={}, Method={}, Payload={}, Headers={}", url, method,
				requestPayload, headers);
		ResponseEntity<T> responseEntity;

		HttpEntity<Object> entity = headers != null
	...
	public <T> T callExternalApi(String url, TypeReference<T> typeReference, HttpMethod method, Object requestPayload,
			HttpHeaders headers) throws JsonProcessingException {

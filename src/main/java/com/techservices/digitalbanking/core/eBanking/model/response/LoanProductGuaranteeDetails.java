...
public class LoanProductGuaranteeDetails {
  ...
  public LoanProductGuaranteeDetails minimumGuaranteeFromGuarantor(
      BigDecimal minimumGuaranteeFromGuarantor) {
  ...
  public LoanProductGuaranteeDetails minimumGuaranteeFromOwnFunds(
      BigDecimal minimumGuaranteeFromOwnFunds) {
  ...
  public int hashCode() {
    ...
    return Objects.hash(
        id, mandatoryGuarantee, minimumGuaranteeFromGuarantor, minimumGuaranteeFromOwnFunds, _new);
  }
  ...
  public String toString() {
    ...
    sb.append("    minimumGuaranteeFromGuarantor: ")
        .append(toIndentedString(minimumGuaranteeFromGuarantor))
        .append("\n");
    sb.append("    minimumGuaranteeFromOwnFunds: ")
        .append(toIndentedString(minimumGuaranteeFromOwnFunds))
        .append("\n");

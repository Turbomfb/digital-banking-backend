...
public class GetLoanProductsPrincipalVariationsForBorrowerCycle {
  ...
  public GetLoanProductsPrincipalVariationsForBorrowerCycle borrowerCycleNumber(
      Integer borrowerCycleNumber) {
  ...
  public GetLoanProductsPrincipalVariationsForBorrowerCycle paramType(
      GetLoanProductsParamType paramType) {
  ...
  public boolean equals(Object o) {
    ...
    GetLoanProductsPrincipalVariationsForBorrowerCycle
        getLoanProductsPrincipalVariationsForBorrowerCycle =
            (GetLoanProductsPrincipalVariationsForBorrowerCycle) o;
    return Objects.equals(
            this.borrowerCycleNumber,
            getLoanProductsPrincipalVariationsForBorrowerCycle.borrowerCycleNumber)
        && Objects.equals(
            this.defaultValue, getLoanProductsPrincipalVariationsForBorrowerCycle.defaultValue)
        && Objects.equals(this.id, getLoanProductsPrincipalVariationsForBorrowerCycle.id)
        && Objects.equals(
            this.maxValue, getLoanProductsPrincipalVariationsForBorrowerCycle.maxValue)
        && Objects.equals(
            this.minValue, getLoanProductsPrincipalVariationsForBorrowerCycle.minValue)
        && Objects.equals(
            this.paramType, getLoanProductsPrincipalVariationsForBorrowerCycle.paramType)
        && Objects.equals(
            this.valueConditionType,
  ...
  public int hashCode() {
    ...
    return Objects.hash(
        borrowerCycleNumber, defaultValue, id, maxValue, minValue, paramType, valueConditionType);
  }
  ...
  public String toString() {
    ...
    sb.append("    borrowerCycleNumber: ")
        .append(toIndentedString(borrowerCycleNumber))
        .append("\n");

...
public class GetLoanAccountingMappings {
  ...
  public GetLoanAccountingMappings incomeFromFeeAccount(
      GetLoanIncomeFromFeeAccount incomeFromFeeAccount) {
  ...
  public void setIncomeFromPenaltyAccount(
      GetLoanIncomeFromPenaltyAccount incomeFromPenaltyAccount) {

    this.incomeFromPenaltyAccount = incomeFromPenaltyAccount;
  }

  public GetLoanAccountingMappings interestOnLoanAccount(
      GetLoanInterestOnLoanAccount interestOnLoanAccount) {
  ...
  public GetLoanAccountingMappings loanPortfolioAccount(
      GetLoanPortfolioAccount loanPortfolioAccount) {
  ...
  public void setOverpaymentLiabilityAccount(
      GetLoanOverpaymentLiabilityAccount overpaymentLiabilityAccount) {
  ...
  public void setTransfersInSuspenseAccount(
      GetLoanTransfersInSuspenseAccount transfersInSuspenseAccount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fundSourceAccount, getLoanAccountingMappings.fundSourceAccount)
        ...
        && Objects.equals(
            this.incomeFromPenaltyAccount, getLoanAccountingMappings.incomeFromPenaltyAccount)
        && Objects.equals(
            this.interestOnLoanAccount, getLoanAccountingMappings.interestOnLoanAccount)
        && Objects.equals(this.loanPortfolioAccount, getLoanAccountingMappings.loanPortfolioAccount)
        && Objects.equals(
            this.overpaymentLiabilityAccount, getLoanAccountingMappings.overpaymentLiabilityAccount)
        && Objects.equals(
            this.transfersInSuspenseAccount, getLoanAccountingMappings.transfersInSuspenseAccount)
  ...
  public String toString() {
    ...
    sb.append("    incomeFromFeeAccount: ")
        .append(toIndentedString(incomeFromFeeAccount))
        .append("\n");
    sb.append("    incomeFromPenaltyAccount: ")
        .append(toIndentedString(incomeFromPenaltyAccount))
        .append("\n");
    sb.append("    interestOnLoanAccount: ")
        .append(toIndentedString(interestOnLoanAccount))
        .append("\n");
    sb.append("    loanPortfolioAccount: ")
        .append(toIndentedString(loanPortfolioAccount))
        .append("\n");
    sb.append("    overpaymentLiabilityAccount: ")
        .append(toIndentedString(overpaymentLiabilityAccount))
        .append("\n");
    sb.append("    transfersInSuspenseAccount: ")
        .append(toIndentedString(transfersInSuspenseAccount))
        .append("\n");

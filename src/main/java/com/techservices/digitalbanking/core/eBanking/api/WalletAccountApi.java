...
public interface WalletAccountApi {
  ...
  GetSavingsAccountsAccountIdResponse retrieveOneByAccountNo(
      @PathVariable("accountNo") String accountNo);

  @PostMapping(value = "/walletaccounts/{walletAccountNo}")
  PostSavingsAccountsAccountIdResponse handleCommand(
      @PathVariable("walletAccountNo") Long walletAccountNo,
  ...
  GetSavingsAccountsResponse retrieveAll(
      @RequestParam(value = "sqlSearch", required = false) @Valid String sqlSearch,
  ...
  PostSavingsAccountTransactionsResponse handleTransactionCommand(
      @PathVariable("walletAccountNo") String walletAccountNo,
      @Valid @RequestBody
  ...
  PostSavingsAccountTransactionsResponse handleCommandUsingTransactionId(
      @PathVariable("walletAccountNo") Long walletAccountNo,
      @Valid @RequestBody
          PostSavingsAccountTransactionsRequest postSavingsAccountTransactionsRequest,
  ...
  SavingsAccountTransactionData retrieveOneTransaction(
      @PathVariable("walletAccountNo") String walletAccountNo,
      @PathVariable("transactionId") Long transactionId);
  ...
  FineractPageResponse<SavingsAccountTransactionData> retrieveTransactions(
      @PathVariable("walletAccountNo") Long walletAccountNo,
  ...
  SavingsAccountTransactionData getTransactionDetails(
      @PathVariable("walletAccountNo") Long walletAccountNo,

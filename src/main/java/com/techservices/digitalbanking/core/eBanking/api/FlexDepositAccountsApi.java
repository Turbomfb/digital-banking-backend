...
public interface FlexDepositAccountsApi {
  ...
  @Operation(
      summary = "Create a recurring deposit account",
      description = "Creates a recurring deposit account")
  FlexInvestmentCreationResponse create(@RequestBody FlexInvestmentCreationRequest request);

  @GetMapping("flexaccounts/{accountId}")
  @Operation(
      summary = "Get a recurring deposit account by ID",
      description = "Gets a recurring deposit account")
  ...
  @Operation(
      summary = "Get all recurring deposit accounts",
      description = "Gets all recurring deposit accounts")
  List<GetRecurringDepositAccountsResponse> retrieveAll();

  @PutMapping("flexaccounts/{accountId}")
  @Operation(
      summary = "Update a recurring deposit account",
      description = "Updates a recurring deposit account")
  GetRecurringDepositAccountsResponse update(
      @Parameter(
              in = ParameterIn.PATH,
              name = "accountId",
              required = true,
              description = "The recurring deposit account id")
          @PathVariable("accountId")
          Long accountId,
  ...
  @Operation(
      summary =
          "Approve a recurring deposit account | Activate a recurring deposit account | Undo approval | Reject recurring deposit account request | Pre-liquidate recurring deposit account | Mature closure")
  PostRecurringDepositAccountsResponse processCommand(
      @Parameter(
          ...
          @PathVariable("accountId")
          Long accountId,
      PostRecurringDepositAccountsAccountIdRequest request,
      @RequestParam(value = "command") String command);

  @GetMapping("flexaccounts/{accountId}/transactions/{transactionId}")
  GetRecurringDepositTransactionResponse retrieveOneTransaction(
      @PathVariable String accountId, @PathVariable Long transactionId);

  @PostMapping("flexaccounts/{accountId}/transactions")
  PostRecurringDepositTransactionCommandResponse processTransactionCommand(
      @PathVariable String accountId,
      @RequestBody
          PostRecurringDepositTransactionCommandRequest
              postRecurringDepositTransactionCommandRequest,

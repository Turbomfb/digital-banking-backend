...
@Schema(name = "GetLoansLoanIdChargesChargeIdResponse", description = "GetLoansLoanIdChargesChargeIdResponse")
...
public class GetLoansLoanIdChargesChargeIdResponse {
	 ...
	 */
	@Schema(name = "amountOrPercentage", example = "100", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "amountOutstanding", example = "100", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 */
	@Schema(name = "amountPercentageAppliedTo", example = "0", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	 ...
	 * @return name
	 */
	@Schema(name = "name", example = "Loan Processing fee", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@JsonProperty("name")
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.amount, getLoansLoanIdChargesChargeIdResponse.amount)
				...
				&& Objects.equals(this.amountPercentageAppliedTo,
				...
				&& Objects.equals(this.chargeCalculationType,
						getLoansLoanIdChargesChargeIdResponse.chargeCalculationType)
	...
	@Override
	public int hashCode() {
		return Objects.hash(amount, amountOrPercentage, amountOutstanding, amountPaid, amountPercentageAppliedTo,
				amountWaived, amountWrittenOff, chargeCalculationType, chargeId, chargeTimeType, currency, id, name,
				penalty, percentage);
	}

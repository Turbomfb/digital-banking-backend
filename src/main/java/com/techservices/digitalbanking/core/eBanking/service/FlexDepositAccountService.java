...
public class FlexDepositAccountService {
  ...
  public GetRecurringDepositAccountsResponse updateAnInvestment(
      String investmentId, PutRecurringDepositProductRequest putRecurringDepositProductRequest) {

    return flexDepositAccountsApiClient.update(
        Long.valueOf(investmentId), putRecurringDepositProductRequest);
  }

  public GetRecurringDepositTransactionResponse retrieveInvestmentTransactionById(
  ...
  public PostRecurringDepositTransactionCommandResponse processInvestmentTransactionCommand(
      String investmentId, RecurringDepositTransactionCommandRequest request, String command) {

    PostRecurringDepositTransactionCommandRequest postRecurringDepositTransactionCommandRequest =
        new PostRecurringDepositTransactionCommandRequest();
    postRecurringDepositTransactionCommandRequest.setNote(request.getNote());
    postRecurringDepositTransactionCommandRequest.setTransactionAmount(
    ...
    return flexDepositAccountsApiClient.processTransactionCommand(
        investmentId, postRecurringDepositTransactionCommandRequest, command);
  }
}

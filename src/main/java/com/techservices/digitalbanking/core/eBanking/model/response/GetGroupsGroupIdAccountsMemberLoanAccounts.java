...
public class GetGroupsGroupIdAccountsMemberLoanAccounts {
  ...
  public GetGroupsGroupIdAccountsMemberLoanAccounts loanType(
      GetGroupsGroupIdAccountsMemberLoanType loanType) {
  ...
  public GetGroupsGroupIdAccountsMemberLoanAccounts status(
      GetGroupsGroupIdAccountsMemberLoanStatus status) {
  ...
  public boolean equals(Object o) {
    ...
    GetGroupsGroupIdAccountsMemberLoanAccounts getGroupsGroupIdAccountsMemberLoanAccounts =
        (GetGroupsGroupIdAccountsMemberLoanAccounts) o;

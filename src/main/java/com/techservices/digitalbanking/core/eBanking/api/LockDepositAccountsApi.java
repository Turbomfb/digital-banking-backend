...
public interface LockDepositAccountsApi {
	...
	/**
	 * DELETE /lockaccounts/{accountId} : Delete a fixed deposit application At
	 * present we support hard delete of fixed deposit application so long as its in
	 * &#39;Submitted and pending approval&#39; state. One the application is moves
	 * past this state, it is not possible to do a &#39;hard&#39; delete of the
	 * application or the account. An API endpoint will be added to
	...
	/**
	 * POST /lockaccounts/{accountId} : Approve fixed deposit application | Undo
	 * approval fixed deposit application | Reject fixed deposit application |
	...
	/**
	 * GET /lockaccounts/{accountId} : Retrieve a fixed deposit application/account
	 * Retrieves a fixed deposit application/account Example Requests :
	 * fixeddepositaccounts/1 fixeddepositaccounts/1?associations&#x3D;all
	 *
	 * @param accountId
	 */
	...
	/**
	 * GET /lockaccounts/template : Retrieve Fixed Deposit Account Template This is
	 * a convenience resource. It can be useful when building maintenance user
	 * interface screens for fixed deposit applications. The template data returned
	 * consists of any or all of: Field Defaults Allowed Value ListsExample
	...
	/**
	 * PUT /lockaccounts/{accountId} : Modify a fixed deposit application Fixed
	 * deposit application can only be modified when in &#39;Submitted and pending
	 ...
	 * change of interest detail such as rate, compounding period, posting period
	 * etc
	 *
	 * @param accountId
	 *            accountId (required)

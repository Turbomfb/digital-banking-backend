...
public interface LoansApi {
	...
	@PostMapping(value = "/loans/{loanId}/documents", produces = {
			"application/json"}, consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	Object uploadDocument(@Parameter(description = "Loan ID", required = true) @PathVariable Long loanId,
	...
	@PostMapping(value = "/loans/{loanId}/repayment", produces = {"application/json"}, consumes = "application/json")
	...
	List<LoanProductListResponse> getLoanProducts(@RequestParam(value = "fields", required = false) Long fields);
	...
	LoanTransactionResponse getLoanTransactionDetails(@Valid @PathVariable(value = "loanId") Long loanId,

...
public interface CustomerApi {
	...
	PutClientClientIdAddressesResponse updateClientAddress(@PathVariable("externalId") Long externalId,
	...
	List<GetClientClientIdAddressesResponse> getClientAddresses(@PathVariable("externalId") Long externalId,
			@Valid @RequestParam(value = "status", required = false) String status,
			@Valid @RequestParam(value = "type", required = false) Long type);

	@PostMapping(value = "/customer/{externalId}/addresses")
	PostClientClientIdAddressesResponse addClientAddress(@PathVariable("externalId") Long externalId,
	...
	PutClientsClientIdResponse updateClient(@PathVariable String externalId,
	...
	PostClientsClientIdResponse manageClient(@PathVariable("externalId") Long externalId,
	...
	List<@Valid AccountDto> retrieveCustomerAccounts(@PathVariable("externalId") String externalId,
			@RequestParam InvestmentType accountType);

...
public class AccountService {
  ...
  public GetSavingsAccountsResponse retrieveAllSavingsAccounts(
      Long limit, Long offset, Long productId) {

    return walletAccountApiClient.retrieveAll(
        null, null, offset, limit, null, null, productId, null);
  }

  public PostSavingsAccountsResponse createSavingsAccount(
      String externalId, String gender, Long kycTierCode) {
  ...
  public PostSavingsAccountsAccountIdResponse approveSavingsAccount(Long savingsAccountId) {
    ...
    return walletAccountApiClient.handleCommand(
        savingsAccountId, postSavingsAccountsAccountIdRequest, "approve");
  }
  ...
  public PostSavingsAccountsAccountIdResponse activateSavingsAccount(Long savingsAccountId) {
    ...
    postSavingsAccountsAccountIdRequest.setLocale("en");
    return walletAccountApiClient.handleCommand(
        savingsAccountId, postSavingsAccountsAccountIdRequest, "activate");
  }
  ...
  public PostSavingsAccountsAccountIdResponse closeSavingsAccount(
    ...
    if (savingsAccount.getSummary().getAccountBalance().compareTo(BigDecimal.ZERO) > 0
      ...
      throw new AbstractPlatformDomainRuleException(
          "validation.msg.savings.account.balance.not.zero",
    ...
    return walletAccountApiClient.handleCommand(
        savingsAccountId, postSavingsAccountsAccountIdRequest, "close");
  }

  public PostSavingsAccountsAccountIdResponse blockSavingsAccount(
      Long savingsAccountId, String reasonForBlock) {

    PostSavingsAccountsAccountIdRequest postSavingsAccountsAccountIdRequest =
        new PostSavingsAccountsAccountIdRequest();
    postSavingsAccountsAccountIdRequest.setReasonForBlock(reasonForBlock);
    return walletAccountApiClient.handleCommand(
        savingsAccountId, postSavingsAccountsAccountIdRequest, "block");
  }

  public PostSavingsAccountsAccountIdResponse unblockSavingsAccount(Long savingsAccountId) {

    return walletAccountApiClient.handleCommand(
        savingsAccountId, new PostSavingsAccountsAccountIdRequest(), "unblock");
  }

  public PostSavingsAccountsAccountIdResponse blockDebitSavingsAccount(
      Long savingsAccountId, String reasonForBlock) {
    ...
    postSavingsAccountsAccountIdRequest.setReasonForBlock(reasonForBlock);
    return walletAccountApiClient.handleCommand(
        savingsAccountId, new PostSavingsAccountsAccountIdRequest(), "blockDebit");
  }

  public PostSavingsAccountsAccountIdResponse unblockDebitSavingsAccount(Long savingsAccountId) {

    return walletAccountApiClient.handleCommand(
        savingsAccountId, new PostSavingsAccountsAccountIdRequest(), "unblockDebit");
  }

  public PostSavingsAccountsAccountIdResponse blockCreditSavingsAccount(
      Long savingsAccountId, String reasonForBlock) {
    ...
    postSavingsAccountsAccountIdRequest.setReasonForBlock(reasonForBlock);
    return walletAccountApiClient.handleCommand(
        savingsAccountId, postSavingsAccountsAccountIdRequest, "blockCredit");
  }

  public PostSavingsAccountsAccountIdResponse unblockCreditSavingsAccount(Long savingsAccountId) {

    return walletAccountApiClient.handleCommand(
        savingsAccountId, new PostSavingsAccountsAccountIdRequest(), "unblockCredit");
  }
  ...
  public AccountDto retrieveSavingsAccount(String walletAccountNo) {
    ...
    Customer customer =
        customerRepository
            .findByAccountId(walletAccountNo)
            .orElseThrow(
                () ->
                    new AbstractPlatformDomainRuleException(
                        NOT_FOUND, "Savings account not found"));

...
public class PostSelfLoansLoanIdRequest {
	 ...
	 * @return note
	 */
	@Schema(name = "note", example = "Reason loan applicant withdrew from application.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@JsonProperty("note")
	 ...
	 */
	@Schema(name = "withdrawnOnDate", example = "20 September 2011", requiredMode = Schema.RequiredMode.NOT_REQUIRED)

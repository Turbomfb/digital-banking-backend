...
public class GetLoanProductsAccountingMappingOptions {
	...
	@Valid
	private Set<@Valid GetLoanProductsAssetAccountOptions> assetAccountOptions = new LinkedHashSet<>();

	@Valid
	private Set<@Valid GetLoanProductsExpenseAccountOptions> expenseAccountOptions = new LinkedHashSet<>();

	@Valid
	private Set<@Valid GetLoanProductsIncomeAccountOptions> incomeAccountOptions = new LinkedHashSet<>();

	@Valid
	private Set<@Valid GetLoanProductsLiabilityAccountOptions> liabilityAccountOptions = new LinkedHashSet<>();
	...
	public void setAssetAccountOptions(Set<@Valid GetLoanProductsAssetAccountOptions> assetAccountOptions) {
		this.assetAccountOptions = assetAccountOptions;
	}
	...
	@JsonDeserialize(as = LinkedHashSet.class)
	public void setExpenseAccountOptions(Set<@Valid GetLoanProductsExpenseAccountOptions> expenseAccountOptions) {
		this.expenseAccountOptions = expenseAccountOptions;
	}
	...
	@JsonDeserialize(as = LinkedHashSet.class)
	public void setIncomeAccountOptions(Set<@Valid GetLoanProductsIncomeAccountOptions> incomeAccountOptions) {
		this.incomeAccountOptions = incomeAccountOptions;
	}
	...
	@JsonDeserialize(as = LinkedHashSet.class)
	public void setLiabilityAccountOptions(Set<@Valid GetLoanProductsLiabilityAccountOptions> liabilityAccountOptions) {
		this.liabilityAccountOptions = liabilityAccountOptions;
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.assetAccountOptions, getLoanProductsAccountingMappingOptions.assetAccountOptions)
				&& Objects.equals(this.expenseAccountOptions,
						getLoanProductsAccountingMappingOptions.expenseAccountOptions)
				&& Objects.equals(this.incomeAccountOptions,
						getLoanProductsAccountingMappingOptions.incomeAccountOptions)
				&& Objects.equals(this.liabilityAccountOptions,

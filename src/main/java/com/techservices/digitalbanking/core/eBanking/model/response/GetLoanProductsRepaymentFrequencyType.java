...
public class GetLoanProductsRepaymentFrequencyType {
	 ...
	 * @return code
	 */
	@Schema(name = "code", example = "repaymentFrequency.periodFrequencyType.days", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
	@JsonProperty("code")
	...
	public boolean equals(Object o) {
		...
		GetLoanProductsRepaymentFrequencyType getLoanProductsRepaymentFrequencyType = (GetLoanProductsRepaymentFrequencyType) o;

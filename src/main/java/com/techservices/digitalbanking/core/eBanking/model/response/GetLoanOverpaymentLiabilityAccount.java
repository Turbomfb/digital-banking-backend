...
public class GetLoanOverpaymentLiabilityAccount {
  ...
  public boolean equals(Object o) {
    ...
    GetLoanOverpaymentLiabilityAccount getLoanOverpaymentLiabilityAccount =
        (GetLoanOverpaymentLiabilityAccount) o;
    return Objects.equals(this.glCode, getLoanOverpaymentLiabilityAccount.glCode)
        && Objects.equals(this.id, getLoanOverpaymentLiabilityAccount.id)

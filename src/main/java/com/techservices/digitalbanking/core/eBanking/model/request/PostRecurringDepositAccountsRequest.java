...
public class PostRecurringDepositAccountsRequest {
  ...
  public static PostRecurringDepositAccountsRequest parse(
      InvestmentApplicationRequest request, GetRecurringDepositProductProductIdResponse product) {

    PostRecurringDepositAccountsRequest recurringDepositAccountsRequest =
        new PostRecurringDepositAccountsRequest();
    ...
    recurringDepositAccountsRequest.setDepositPeriodFrequencyId(
        product.getMaxDepositTermType().getId());
    ...
    recurringDepositAccountsRequest.setRecurringFrequencyType(
        product.getInMultiplesOfDepositTermType().getId());

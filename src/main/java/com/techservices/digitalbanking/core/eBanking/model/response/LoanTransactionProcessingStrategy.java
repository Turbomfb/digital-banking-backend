...
public class LoanTransactionProcessingStrategy {
   ...
   */
  @Schema(
      name = "interestPrincipalPenaltiesFeesOrderStrategy",
  ...
  public void setInterestPrincipalPenaltiesFeesOrderStrategy(
      Boolean interestPrincipalPenaltiesFeesOrderStrategy) {
   ...
   */
  @Schema(
      name = "principalInterestPenaltiesFeesOrderStrategy",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public void setPrincipalInterestPenaltiesFeesOrderStrategy(
      Boolean principalInterestPenaltiesFeesOrderStrategy) {
  ...
  public boolean equals(Object o) {
    ...
    LoanTransactionProcessingStrategy loanTransactionProcessingStrategy =
        (LoanTransactionProcessingStrategy) o;
    return Objects.equals(this.creocoreStrategy, loanTransactionProcessingStrategy.creocoreStrategy)
        && Objects.equals(
            this.earlyPaymentStrategy, loanTransactionProcessingStrategy.earlyPaymentStrategy)
        && Objects.equals(
            this.heavensfamilyStrategy, loanTransactionProcessingStrategy.heavensfamilyStrategy)
        && Objects.equals(this.id, loanTransactionProcessingStrategy.id)
        && Objects.equals(
            this.indianRBIStrategy, loanTransactionProcessingStrategy.indianRBIStrategy)
        && Objects.equals(
            this.interestPrincipalPenaltiesFeesOrderStrategy,
        ...
        && Objects.equals(
            this.principalInterestPenaltiesFeesOrderStrategy,
            loanTransactionProcessingStrategy.principalInterestPenaltiesFeesOrderStrategy)
        && Objects.equals(
            this.standardStrategy, loanTransactionProcessingStrategy.standardStrategy);
  }
  ...
  public String toString() {
    ...
    sb.append("    earlyPaymentStrategy: ")
        .append(toIndentedString(earlyPaymentStrategy))
        .append("\n");
    sb.append("    heavensfamilyStrategy: ")
        .append(toIndentedString(heavensfamilyStrategy))
        .append("\n");
    ...
    sb.append("    interestPrincipalPenaltiesFeesOrderStrategy: ")
        .append(toIndentedString(interestPrincipalPenaltiesFeesOrderStrategy))
        .append("\n");
    sb.append("    _new: ").append(toIndentedString(_new)).append("\n");
    sb.append("    principalInterestPenaltiesFeesOrderStrategy: ")
        .append(toIndentedString(principalInterestPenaltiesFeesOrderStrategy))
        .append("\n");

...
public class GetLoansTemplateResponse {
  ...
  @Valid private Set<@Valid GetLoansTemplateProductOptions> productOptions = new LinkedHashSet<>();
  ...
  public GetLoansTemplateResponse productOptions(
      Set<@Valid GetLoansTemplateProductOptions> productOptions) {

    this.productOptions = productOptions;
    return this;
  }

  public GetLoansTemplateResponse addProductOptionsItem(
      GetLoansTemplateProductOptions productOptionsItem) {

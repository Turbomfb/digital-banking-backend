...
public class LockDepositAccountService {
  ...
  public GetFixedDepositAccountsResponse retrieveAllInvestments(
      Boolean paged, Integer offset, Integer limit, String orderBy, String sortOrder) {

    List<GetFixedDepositAccountsAccountIdResponse> fixedDepositAccountsAccountIdResponseList =
        lockDepositAccountsApiClient.retrieveAll38(paged, offset, limit, orderBy, sortOrder);
    GetFixedDepositAccountsResponse getFixedDepositAccountsResponse =
        new GetFixedDepositAccountsResponse();
    getFixedDepositAccountsResponse.setPageItems(
        new HashSet<>(fixedDepositAccountsAccountIdResponseList));
    getFixedDepositAccountsResponse.setTotalFilteredRecords(
        fixedDepositAccountsAccountIdResponseList.size());
  ...
  public GetFixedDepositTransactionResponse retrieveInvestmentTransactionById(
      Long investmentId, Long transactionId) {

    return lockDepositAccountsApiClient.retrieveOneTransaction(investmentId, transactionId);
  }

  public List<GetFixedDepositTransactionResponse> retrieveAllInvestmentTransactions(
      String investmentId) {

    GetFixedDepositAccountsAccountIdResponse fixedDepositAccount =
        lockDepositAccountsApiClient.retrieveOne(investmentId);

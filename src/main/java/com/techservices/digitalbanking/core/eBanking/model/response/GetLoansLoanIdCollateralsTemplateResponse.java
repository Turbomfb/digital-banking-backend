...
@Schema(
    name = "GetLoansLoanIdCollateralsTemplateResponse",
...
public class GetLoansLoanIdCollateralsTemplateResponse {
  ...
  @Valid private Set<@Valid Object> allowedCollateralTypes = new LinkedHashSet<>();

  public GetLoansLoanIdCollateralsTemplateResponse allowedCollateralTypes(
      Set<@Valid Object> allowedCollateralTypes) {

    this.allowedCollateralTypes = allowedCollateralTypes;
    return this;
  }

  public GetLoansLoanIdCollateralsTemplateResponse addAllowedCollateralTypesItem(
      Object allowedCollateralTypesItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetLoansLoanIdCollateralsTemplateResponse getLoansLoanIdCollateralsTemplateResponse =
        (GetLoansLoanIdCollateralsTemplateResponse) o;
    return Objects.equals(
        this.allowedCollateralTypes,
  ...
  public String toString() {
    ...
    sb.append("    allowedCollateralTypes: ")
        .append(toIndentedString(allowedCollateralTypes))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }

...
public class GetLoanProductsTemplateResponse {
  ...
  @Valid
  private Set<@Valid GetLoanProductsAmortizationType> amortizationTypeOptions =
      new LinkedHashSet<>();

  @Valid private Set<@Valid GetLoanProductsChargeOptions> chargeOptions = new LinkedHashSet<>();

  private GetLoanProductsTemplateCurrency currency;

  @Valid private Set<@Valid GetLoanProductsCurrencyOptions> currencyOptions = new LinkedHashSet<>();

  private GetLoansProductsDaysInMonthTemplateType daysInMonthType;

  @Valid
  private Set<@Valid GetLoansProductsDaysInMonthTemplateType> daysInMonthTypeOptions =
      new LinkedHashSet<>();

  private GetLoanProductsDaysInYearTemplateType daysInYearType;

  @Valid
  private Set<@Valid GetLoanProductsInterestTemplateType> daysInYearTypeOptions =
      new LinkedHashSet<>();
  ...
  @Valid
  private Set<@Valid GetLoansProductsInterestCalculationPeriodType>
      interestCalculationPeriodTypeOptions = new LinkedHashSet<>();

  private GetLoanProductsInterestRateTemplateFrequencyType interestRateFrequencyType;

  @Valid
  private Set<@Valid GetLoanProductsInterestRateTemplateFrequencyType>
      interestRateFrequencyTypeOptions = new LinkedHashSet<>();

  @Valid private List<Integer> interestRateVariationsForBorrowerCycle = new ArrayList<>();

  @Valid
  private Set<@Valid GetLoanProductsInterestRecalculationCompoundingType>
      interestRecalculationCompoundingTypeOptions = new LinkedHashSet<>();

  private GetLoanProductsInterestRecalculationTemplateData interestRecalculationData;

  @Valid
  private Set<@Valid GetLoanProductsInterestRecalculationCompoundingFrequencyType>
      interestRecalculationFrequencyTypeOptions = new LinkedHashSet<>();

  private GetLoanProductsInterestTemplateType interestType;

  @Valid
  private Set<@Valid GetLoanProductsInterestTemplateType> interestTypeOptions =
      new LinkedHashSet<>();
  ...
  @Valid
  private Set<@Valid GetLoanProductsPreClosureInterestCalculationStrategy>
      preClosureInterestCalculationStrategyOptions = new LinkedHashSet<>();
  ...
  @Valid
  private Set<@Valid GetLoanProductsRepaymentTemplateFrequencyType> repaymentFrequencyTypeOptions =
      new LinkedHashSet<>();

  @Valid
  private Set<@Valid GetLoanProductsRescheduleStrategyType> rescheduleStrategyTypeOptions =
      new LinkedHashSet<>();

  @Valid
  private Set<@Valid GetLoanProductsTransactionProcessingStrategyOptions>
      transactionProcessingStrategyOptions = new LinkedHashSet<>();

  private Boolean useBorrowerCycle;

  @Valid
  private Set<@Valid GetLoanProductsValueConditionTypeOptions> valueConditionTypeOptions =
      new LinkedHashSet<>();
  ...
  public void setAccountingMappingOptions(
      GetLoanProductsAccountingMappingOptions accountingMappingOptions) {

    this.accountingMappingOptions = accountingMappingOptions;
  }

  public GetLoanProductsTemplateResponse accountingRule(
      GetLoanProductsAccountingRule accountingRule) {
  ...
  public void setAccountingRuleOptions(
      Set<@Valid GetLoanProductsAccountingRule> accountingRuleOptions) {

    this.accountingRuleOptions = accountingRuleOptions;
  }

  public GetLoanProductsTemplateResponse amortizationType(
      GetLoanProductsAmortizationType amortizationType) {
  ...
  public GetLoanProductsTemplateResponse chargeOptions(
      Set<@Valid GetLoanProductsChargeOptions> chargeOptions) {

    this.chargeOptions = chargeOptions;
    return this;
  }

  public GetLoanProductsTemplateResponse addChargeOptionsItem(
      GetLoanProductsChargeOptions chargeOptionsItem) {
  ...
  public GetLoanProductsTemplateResponse currencyOptions(
      Set<@Valid GetLoanProductsCurrencyOptions> currencyOptions) {

    this.currencyOptions = currencyOptions;
    return this;
  }

  public GetLoanProductsTemplateResponse addCurrencyOptionsItem(
      GetLoanProductsCurrencyOptions currencyOptionsItem) {
  ...
  public GetLoanProductsTemplateResponse daysInMonthType(
      GetLoansProductsDaysInMonthTemplateType daysInMonthType) {
  ...
  @JsonDeserialize(as = LinkedHashSet.class)
  public void setDaysInMonthTypeOptions(
      Set<@Valid GetLoansProductsDaysInMonthTemplateType> daysInMonthTypeOptions) {

    this.daysInMonthTypeOptions = daysInMonthTypeOptions;
  }

  public GetLoanProductsTemplateResponse daysInYearType(
      GetLoanProductsDaysInYearTemplateType daysInYearType) {
  ...
  @JsonDeserialize(as = LinkedHashSet.class)
  public void setDaysInYearTypeOptions(
      Set<@Valid GetLoanProductsInterestTemplateType> daysInYearTypeOptions) {
  ...
  public GetLoanProductsTemplateResponse interestCalculationPeriodTypeOptions(
      Set<@Valid GetLoansProductsInterestCalculationPeriodType>
  ...
  @Valid
  @Schema(
      name = "interestCalculationPeriodTypeOptions",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("interestCalculationPeriodTypeOptions")
  public Set<@Valid GetLoansProductsInterestCalculationPeriodType>
  ...
  public GetLoanProductsTemplateResponse interestRateFrequencyTypeOptions(
      Set<@Valid GetLoanProductsInterestRateTemplateFrequencyType>
  ...
  @Valid
  @Schema(
      name = "interestRateFrequencyTypeOptions",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("interestRateFrequencyTypeOptions")
  public Set<@Valid GetLoanProductsInterestRateTemplateFrequencyType>
  ...
  public void setInterestRateVariationsForBorrowerCycle(
      List<Integer> interestRateVariationsForBorrowerCycle) {
  ...
  public GetLoanProductsTemplateResponse interestRecalculationCompoundingTypeOptions(
      Set<@Valid GetLoanProductsInterestRecalculationCompoundingType>
  ...
  public GetLoanProductsTemplateResponse addInterestRecalculationCompoundingTypeOptionsItem(
      GetLoanProductsInterestRecalculationCompoundingType
          interestRecalculationCompoundingTypeOptionsItem) {
    ...
    this.interestRecalculationCompoundingTypeOptions.add(
        interestRecalculationCompoundingTypeOptionsItem);
    return this;
  }
  ...
  @Valid
  @Schema(
      name = "interestRecalculationCompoundingTypeOptions",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("interestRecalculationCompoundingTypeOptions")
  public Set<@Valid GetLoanProductsInterestRecalculationCompoundingType>
  ...
  public GetLoanProductsTemplateResponse interestRecalculationFrequencyTypeOptions(
      Set<@Valid GetLoanProductsInterestRecalculationCompoundingFrequencyType>
  ...
  @Valid
  @Schema(
      name = "interestRecalculationFrequencyTypeOptions",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("interestRecalculationFrequencyTypeOptions")
  public Set<@Valid GetLoanProductsInterestRecalculationCompoundingFrequencyType>
  ...
  public GetLoanProductsTemplateResponse interestType(
      GetLoanProductsInterestTemplateType interestType) {
  ...
  @JsonDeserialize(as = LinkedHashSet.class)
  public void setInterestTypeOptions(
      Set<@Valid GetLoanProductsInterestTemplateType> interestTypeOptions) {

    this.interestTypeOptions = interestTypeOptions;
  }

  public GetLoanProductsTemplateResponse isInterestRecalculationEnabled(
  ...
  public GetLoanProductsTemplateResponse addNumberOfRepaymentVariationsForBorrowerCycleItem(
    ...
    this.numberOfRepaymentVariationsForBorrowerCycle.add(
        numberOfRepaymentVariationsForBorrowerCycleItem);
    return this;
  }
  ...
  @JsonDeserialize(as = LinkedHashSet.class)
  public void setPaymentTypeOptions(
      Set<@Valid GetLoanProductsPaymentTypeOptions> paymentTypeOptions) {
  ...
  public GetLoanProductsTemplateResponse preClosureInterestCalculationStrategyOptions(
      Set<@Valid GetLoanProductsPreClosureInterestCalculationStrategy>
  ...
  public GetLoanProductsTemplateResponse addPreClosureInterestCalculationStrategyOptionsItem(
      GetLoanProductsPreClosureInterestCalculationStrategy
          preClosureInterestCalculationStrategyOptionsItem) {
    ...
    this.preClosureInterestCalculationStrategyOptions.add(
        preClosureInterestCalculationStrategyOptionsItem);
    return this;
  }
  ...
  @Valid
  @Schema(
      name = "preClosureInterestCalculationStrategyOptions",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("preClosureInterestCalculationStrategyOptions")
  public Set<@Valid GetLoanProductsPreClosureInterestCalculationStrategy>
  ...
  public void setPrincipalVariationsForBorrowerCycle(
      List<Integer> principalVariationsForBorrowerCycle) {
  ...
  public Set<@Valid GetLoanProductsRepaymentTemplateFrequencyType>
  ...
  public GetLoanProductsTemplateResponse transactionProcessingStrategyOptions(
      Set<@Valid GetLoanProductsTransactionProcessingStrategyOptions>
  ...
  public GetLoanProductsTemplateResponse addTransactionProcessingStrategyOptionsItem(
      GetLoanProductsTransactionProcessingStrategyOptions
          transactionProcessingStrategyOptionsItem) {
  ...
  @Valid
  @Schema(
      name = "transactionProcessingStrategyOptions",
      requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("transactionProcessingStrategyOptions")
  public Set<@Valid GetLoanProductsTransactionProcessingStrategyOptions>
  ...
  public boolean equals(Object o) {
    ...
    GetLoanProductsTemplateResponse getLoanProductsTemplateResponse =
        (GetLoanProductsTemplateResponse) o;
    return Objects.equals(
            this.accountingMappingOptions, getLoanProductsTemplateResponse.accountingMappingOptions)
        && Objects.equals(this.accountingRule, getLoanProductsTemplateResponse.accountingRule)
        && Objects.equals(
            this.accountingRuleOptions, getLoanProductsTemplateResponse.accountingRuleOptions)
        && Objects.equals(this.amortizationType, getLoanProductsTemplateResponse.amortizationType)
        && Objects.equals(
            this.amortizationTypeOptions, getLoanProductsTemplateResponse.amortizationTypeOptions)
        ...
        && Objects.equals(
            this.daysInMonthTypeOptions, getLoanProductsTemplateResponse.daysInMonthTypeOptions)
        && Objects.equals(this.daysInYearType, getLoanProductsTemplateResponse.daysInYearType)
        && Objects.equals(
            this.daysInYearTypeOptions, getLoanProductsTemplateResponse.daysInYearTypeOptions)
        && Objects.equals(
            this.includeInBorrowerCycle, getLoanProductsTemplateResponse.includeInBorrowerCycle)
        && Objects.equals(
        ...
        && Objects.equals(
            this.interestRecalculationCompoundingTypeOptions,
        ...
        && Objects.equals(
            this.interestRecalculationFrequencyTypeOptions,
        ...
        && Objects.equals(
            this.interestTypeOptions, getLoanProductsTemplateResponse.interestTypeOptions)
        && Objects.equals(
        ...
        && Objects.equals(
            this.paymentTypeOptions, getLoanProductsTemplateResponse.paymentTypeOptions)
        && Objects.equals(
            this.preClosureInterestCalculationStrategyOptions,
        ...
        && Objects.equals(
            this.repaymentFrequencyType, getLoanProductsTemplateResponse.repaymentFrequencyType)
        && Objects.equals(
            this.repaymentFrequencyTypeOptions,
            getLoanProductsTemplateResponse.repaymentFrequencyTypeOptions)
        && Objects.equals(
            this.rescheduleStrategyTypeOptions,
        ...
        && Objects.equals(
            this.valueConditionTypeOptions,
  ...
  public String toString() {
    ...
    sb.append("    accountingMappingOptions: ")
        .append(toIndentedString(accountingMappingOptions))
        .append("\n");
    sb.append("    accountingRule: ").append(toIndentedString(accountingRule)).append("\n");
    sb.append("    accountingRuleOptions: ")
        .append(toIndentedString(accountingRuleOptions))
        .append("\n");
    sb.append("    amortizationType: ").append(toIndentedString(amortizationType)).append("\n");
    sb.append("    amortizationTypeOptions: ")
        .append(toIndentedString(amortizationTypeOptions))
        .append("\n");
    ...
    sb.append("    daysInMonthTypeOptions: ")
        .append(toIndentedString(daysInMonthTypeOptions))
        .append("\n");
    sb.append("    daysInYearType: ").append(toIndentedString(daysInYearType)).append("\n");
    sb.append("    daysInYearTypeOptions: ")
        .append(toIndentedString(daysInYearTypeOptions))
        .append("\n");
    sb.append("    includeInBorrowerCycle: ")
        .append(toIndentedString(includeInBorrowerCycle))
        .append("\n");
    sb.append("    interestCalculationPeriodType: ")
        .append(toIndentedString(interestCalculationPeriodType))
        .append("\n");
    sb.append("    interestCalculationPeriodTypeOptions: ")
        .append(toIndentedString(interestCalculationPeriodTypeOptions))
        .append("\n");
    sb.append("    interestRateFrequencyType: ")
        .append(toIndentedString(interestRateFrequencyType))
        .append("\n");
    sb.append("    interestRateFrequencyTypeOptions: ")
        .append(toIndentedString(interestRateFrequencyTypeOptions))
        .append("\n");
    sb.append("    interestRateVariationsForBorrowerCycle: ")
        .append(toIndentedString(interestRateVariationsForBorrowerCycle))
        .append("\n");
    sb.append("    interestRecalculationCompoundingTypeOptions: ")
        .append(toIndentedString(interestRecalculationCompoundingTypeOptions))
        .append("\n");
    sb.append("    interestRecalculationData: ")
        .append(toIndentedString(interestRecalculationData))
        .append("\n");
    sb.append("    interestRecalculationFrequencyTypeOptions: ")
        .append(toIndentedString(interestRecalculationFrequencyTypeOptions))
        .append("\n");
    sb.append("    interestType: ").append(toIndentedString(interestType)).append("\n");
    sb.append("    interestTypeOptions: ")
        .append(toIndentedString(interestTypeOptions))
        .append("\n");
    sb.append("    isInterestRecalculationEnabled: ")
        .append(toIndentedString(isInterestRecalculationEnabled))
        .append("\n");
    sb.append("    numberOfRepaymentVariationsForBorrowerCycle: ")
        .append(toIndentedString(numberOfRepaymentVariationsForBorrowerCycle))
        .append("\n");
    ...
    sb.append("    preClosureInterestCalculationStrategyOptions: ")
        .append(toIndentedString(preClosureInterestCalculationStrategyOptions))
        .append("\n");
    sb.append("    principalVariationsForBorrowerCycle: ")
        .append(toIndentedString(principalVariationsForBorrowerCycle))
        .append("\n");
    sb.append("    repaymentFrequencyType: ")
        .append(toIndentedString(repaymentFrequencyType))
        .append("\n");
    sb.append("    repaymentFrequencyTypeOptions: ")
        .append(toIndentedString(repaymentFrequencyTypeOptions))
        .append("\n");
    sb.append("    rescheduleStrategyTypeOptions: ")
        .append(toIndentedString(rescheduleStrategyTypeOptions))
        .append("\n");
    sb.append("    transactionProcessingStrategyOptions: ")
        .append(toIndentedString(transactionProcessingStrategyOptions))
        .append("\n");
    sb.append("    useBorrowerCycle: ").append(toIndentedString(useBorrowerCycle)).append("\n");
    sb.append("    valueConditionTypeOptions: ")
        .append(toIndentedString(valueConditionTypeOptions))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }

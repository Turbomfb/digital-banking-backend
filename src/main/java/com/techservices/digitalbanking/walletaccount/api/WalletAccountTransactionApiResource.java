...
@Tag(
    ...
    description =
        "Operations for managing savings account transactions, payments, statements, and receipts")
...
public class WalletAccountTransactionApiResource {
  ...
  @Operation(
      summary = "Process transaction command",
      description =
          "Processes various transaction commands for the authenticated customer's savings account. Default command generates OTP for transaction verification.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid request data or command parameters",
  ...
  public ResponseEntity<GenericApiResponse> processTransactionCommand(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              description =
                  "Transaction request containing amount, recipient details, and transaction parameters",
              required = true,
              content =
                  @Content(
                      mediaType = "application/json",
                      schema = @Schema(implementation = SavingsAccountTransactionRequest.class)))
          @RequestBody
          SavingsAccountTransactionRequest request,
      @Parameter(
              name = "command",
              description =
                  "Transaction command to execute. Defaults to 'GENERATE_OTP_COMMAND' if not specified.",
              schema =
                  @Schema(
                      type = "string",
                      defaultValue = GENERATE_OTP_COMMAND,
                      example = GENERATE_OTP_COMMAND))
    ...
    return ResponseEntity.ok(
        walletAccountTransactionService.processTransactionCommand(command, request, customerId));
  }

  @Operation(
      summary = "Initiate payment order",
      description =
          "Initiates a new payment order for transferring funds from the customer's wallet account to external recipients.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = WalletPaymentOrderResponse.class))),
        @ApiResponse(
            responseCode = "400",
        ...
        @ApiResponse(
            responseCode = "422",
            description = "Payment processing failed due to business rules",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "500",
            description = "Internal server error",
  ...
  public ResponseEntity<WalletPaymentOrderResponse> initiatePaymentOrder(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              description =
                  "Payment order request containing recipient details, amount, and payment instructions",
              required = true,
              content =
                  @Content(
                      mediaType = "application/json",
    ...
    Long customerId = springSecurityAuditorAware.getAuthenticatedUser().getUserId();
    WalletPaymentOrderResponse responseOrder =
        walletAccountTransactionService.initiatePaymentOrder(request, customerId);
  ...
  @Operation(
      ...
      description =
          "Handles incoming webhook notifications from external payment providers to update transaction statuses and process callbacks.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "422",
            description = "Webhook payload could not be processed",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "500",
            description = "Internal server error",
  ...
  public ResponseEntity<GenericApiResponse> receiveInboundWebhook(
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
              description =
                  "Webhook payload from external payment provider containing transaction updates",
              required = true,
              content =
                  @Content(
                      mediaType = "application/json",
    ...
    try {
      GenericApiResponse webhookResponse =
          walletAccountTransactionService.receiveInboundWebhook(request);
      return ResponseEntity.ok(webhookResponse);
    } catch (Exception e) {
      log.error("Error processing webhook: {}", e.getMessage(), e);
      throw new ValidationException(
          "error.webhook.processing", "Unable to process webhook notification.", e.getMessage());
    }
  }

  @Operation(
      summary = "Retrieve savings account transactions",
      description =
          "Retrieves a paginated list of transactions for the authenticated customer's savings account with optional filtering by date range, transaction type, and product ID.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<BasePageResponse<TransactionDto>> retrieveSavingsAccountTransactions(
    ...
    try {
      ...
      BasePageResponse<TransactionDto> savingsAccountTransactions =
      ...
      log.error(
          "Error retrieving transactions for customer {}: {}",
          springSecurityAuditorAware.getAuthenticatedUser().getUserId(),
          e.getMessage(),
          e);
      throw new ValidationException(
          "error.transaction.retrieval",
  ...
  @Operation(
      ...
      description =
          "Generates and exports account statement in various formats (CSV, PDF, Excel) for a specified date range. The generated file is directly streamed to the client for download.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Void> generateAccountStatement(
      @Parameter(
              name = "startDate",
              description = "Start date for statement period (ISO date format: YYYY-MM-DD)",
      ...
      @Parameter(
              name = "endDate",
              description = "End date for statement period (ISO date format: YYYY-MM-DD)",
      ...
      @Parameter(
              ...
              schema =
                  @Schema(type = "integer", format = "int64", minimum = "0", defaultValue = "0"))
          @RequestParam(value = "offset", required = false, defaultValue = "0")
          @Min(0)
          Long offset,
      @Parameter(
              name = "limit",
              description = "Maximum number of records to include in statement",
              schema =
                  @Schema(
                      type = "integer",
                      format = "int64",
      ...
      @Parameter(
              name = "format",
              description = "Export format for the statement",
              schema =
                  @Schema(
                      type = "string",
                      allowableValues = {"CSV", "PDF", "EXCEL"},
                      defaultValue = "CSV"))
          @RequestParam(value = "format", required = false, defaultValue = "CSV")
          @Pattern(regexp = "CSV|PDF|EXCEL")
          String format,
      @Parameter(
              name = "includeReversals",
              description = "Whether to include reversed transactions in the statement",
              schema = @Schema(type = "boolean", defaultValue = "false"))
          @RequestParam(value = "includeReversals", required = false, defaultValue = "false")
      ...
      @Parameter(
              ...
              schema =
                  @Schema(
                      ...
                      allowableValues = {"CREDIT", "DEBIT", "ALL"}))
          @RequestParam(value = "transactionType", required = false)
          @Pattern(regexp = "CREDIT|DEBIT|ALL")
    ...
    try {
      ...
      StatementRequest statementRequest =
          StatementRequest.buildStatementRequest(
              startDate, endDate, productId, offset, limit, includeReversals, transactionType);
      ...
      log.info(
          "Date Range: {} to {}", statementRequest.getStartDate(), statementRequest.getEndDate());
      ...
      log.error(
          "Error generating statement for customer {}: {}",
          springSecurityAuditorAware.getAuthenticatedUser().getUserId(),
          e.getMessage(),
          e);
      throw new ValidationException(
  ...
  @Operation(
      ...
      description =
          "Retrieves detailed information for a specific transaction belonging to the authenticated customer's savings account.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = SavingsAccountTransactionData.class))),
        @ApiResponse(
            responseCode = "400",
        ...
        @ApiResponse(
            responseCode = "403",
            description = "Access denied - transaction does not belong to authenticated user",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "404",
  ...
  public ResponseEntity<SavingsAccountTransactionData> retrieveSavingsAccountTransactionById(
    ...
    try {
      Long customerId = springSecurityAuditorAware.getAuthenticatedUser().getUserId();
      return ResponseEntity.ok(
          walletAccountTransactionService.retrieveSavingsAccountTransactionById(
              customerId, transactionId));
    } catch (Exception e) {
      log.error(
          "Error retrieving transaction {} for customer {}: {}",
          transactionId,
          springSecurityAuditorAware.getAuthenticatedUser().getUserId(),
          e.getMessage(),
          e);
      throw new ValidationException(
          ...
          "We're unable to find the requested transaction.",
          e.getMessage());
    }
  }
  ...
  @Operation(
      ...
      description =
          "Generates and exports transaction receipt in various formats (PDF, PNG, JPEG) for a specific transaction. The receipt includes transaction details, customer information, and bank branding.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "400",
            description = "Invalid request parameters or transaction reference not found",
            content = @Content(mediaType = "application/json")),
        @ApiResponse(
            responseCode = "401",
            description = "Authentication required",
  ...
  public ResponseEntity<Void> generateTransactionReceipt(
      @Parameter(
              name = "format",
              description = "Export format for the receipt",
              schema =
                  @Schema(
                      type = "string",
                      allowableValues = {"PDF", "PNG", "JPEG"},
                      defaultValue = "PDF"))
          @RequestParam(value = "format", required = false, defaultValue = "PDF")
          @Pattern(regexp = "PDF|PNG|JPEG")
          String format,
      @Parameter(
              name = "reference",
              description =
                  "Transaction reference number used to retrieve transaction details from cache",
              required = true,
              schema = @Schema(type = "string", example = "TXN123456789"))
    ...
    try {
      SavingsAccountTransactionRequest savingsAccountTransactionRequest =
          this.redisService.retrieveData(reference, SavingsAccountTransactionRequest.class);
      Long customerId = springSecurityAuditorAware.getAuthenticatedUser().getUserId();

      log.info(
          "Generating receipt for transaction: {} for customer: {} in format: {}",
          reference,
          customerId,
          format);

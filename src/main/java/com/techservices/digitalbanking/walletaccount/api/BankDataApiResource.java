...
@Tag(
    ...
    description =
        "API for retrieving financial institution data and performing account verification services")
...
public class BankDataApiResource {
  ...
  @Operation(
      ...
      description =
          "Fetches comprehensive information about all registered financial institutions including "
  ...
  @Operation(
      ...
      description =
          "Performs real-time account verification by validating account details with the respective "
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "400",
            description =
                "Invalid request parameters - missing or malformed account number, invalid bank code, or unsupported account type",
            content = @Content(schema = @Schema(hidden = true))),
        @ApiResponse(
            responseCode = "404",
        ...
        @ApiResponse(
            responseCode = "422",
            description =
                "Account verification failed due to inactive account status, restricted account, or validation errors",
            content = @Content(schema = @Schema(hidden = true))),
        @ApiResponse(
            responseCode = "500",
        ...
        @ApiResponse(
            responseCode = "502",
            description =
                "External bank service error - unable to connect to financial institution's verification service",
            content = @Content(schema = @Schema(hidden = true))),
        @ApiResponse(
            responseCode = "504",
            description =
                "Name enquiry request timeout - financial institution did not respond within acceptable timeframe",
            content = @Content(schema = @Schema(hidden = true)))
      })
  ...
  public ResponseEntity<NameEnquiryResponse> processNameEnquiry(
      @Parameter(
              description =
                  "Account verification request containing the target account number, "

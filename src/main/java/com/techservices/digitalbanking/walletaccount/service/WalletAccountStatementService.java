...
public interface WalletAccountStatementService {
  ...
  void generateCsvStatement(
      StatementRequest statementRequest, HttpServletResponse response, Customer customer)
      throws IOException;

  void generatePdfStatement(
      StatementRequest statementRequest, HttpServletResponse response, Customer customer)
      throws IOException;

  void generateExcelStatement(
      StatementRequest statementRequest, HttpServletResponse response, Customer customer)
      throws IOException;
}

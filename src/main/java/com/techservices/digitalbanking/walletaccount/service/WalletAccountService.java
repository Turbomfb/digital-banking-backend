...
public interface WalletAccountService {
  ...
  PostSavingsAccountsResponse createSavingsAccount(
      CreateSavingsAccountRequest fixedDepositApplicationRequest);

  AccountDto retrieveSavingsAccountById(Long customerId);

  BasePageResponse<SavingsInterestBreakdownResponse> calculateInterestBreakdown(
